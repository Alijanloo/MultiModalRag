...
% 
% Note: 
% 1. If you want to cite something, add the reference in the main.tex bibliography section
% and then use \cite{reference-key} in this template file.
% 2. Wrap the inline english terms with the \lr{text} tag
% 3. Use the original English terms only for the Important concepts that their Persian equivalents are not well-known
